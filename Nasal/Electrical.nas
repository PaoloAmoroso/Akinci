...
init_switches = func() {
  ...
  setprop("instrumentation/transponder/stby-code",getprop("instrumentation/transponder/id-code"));
  ...
  append(switch_list,"systems/electrical/outputs/efis");
  append(output_list,"efis");
  append(watt_list,0.2);
