...
#  view             : 100 Il s'agit de l'index reel de la view, disponible ici : /sim/current-view/view-number-raw
...
#  view             : 100 View index. Can be found here : /sim/current-view/view-number-raw
...
#création de l'objet
var FlirTurret = turret.new("FlirTurret",0,100,"sim/model/turret[0]/heading","sim/model/turret[0]/pitch",0,0,60,-90,20,60);
...
# var tourelledetoit = turret.new("TourelledeToit",0,101,"sim/model/turret[0]/heading","sim/model/turret[0]/pitch");
